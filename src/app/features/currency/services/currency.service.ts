...
export class CurrencyService {
  ...
  getLatest({base_currency, currencies}: {
    ...
    // return of({"data": {"EUR": 0.9609501015}})
      .pipe(
        map(({data}) => data)
      );
  }
