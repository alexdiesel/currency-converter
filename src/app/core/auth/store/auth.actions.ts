...
export const reg = createAction(REG, props<RegForm>());

export const regSuccess = createAction(REG_SUCCESS, props<User>());

export const regFailure = createAction(REG_FAILURE, props<{ error: string }>());

export const login = createAction(LOGIN, props<LoginForm>());
